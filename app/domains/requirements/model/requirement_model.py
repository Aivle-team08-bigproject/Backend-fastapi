"""hanacard DB, service.requirements 테이블 매핑 (V7__service_schema.sql 기준).

app_svc 커넥션(app/db/hanacard_app_session.py)의 Base를 사용한다.
...
from app.db.hanacard_app_session import Base
