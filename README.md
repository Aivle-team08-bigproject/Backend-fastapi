...
HANACARD_ADMIN_PASSWORD=change-admin-password

HANACARD_AGENT_DATABASE_URL=postgresql+psycopg://agent_svc:change-agent-password@127.0.0.1:5432/hanacard
HANACARD_APP_DATABASE_URL=postgresql+psycopg://app_svc:change-app-password@127.0.0.1:5432/hanacard
HANACARD_MIGRATION_DATABASE_URL=postgresql+psycopg://hanacard_admin:change-admin-password@127.0.0.1:5432/hanacard
