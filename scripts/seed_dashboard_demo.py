...
DEMO_EMPLOYEES = [
    ...
    ("HANA-PARK-001", "박준영", "데이터 선별 파트", EmployeeStatus.ACTIVE, {PermissionCode.DATA_PRODUCT_READ}),
    ("HANA-CHOI-001", "최수민", "외부 협력 파트", EmployeeStatus.DISABLED, {PermissionCode.DATA_PRODUCT_READ}),
    ("HANA-OPS-001", "정하늘", "플랫폼 운영 파트", EmployeeStatus.ACTIVE, {PermissionCode.DATA_PRODUCT_READ}),
    ("HANA-QA-001", "윤서진", "품질 검증 파트", EmployeeStatus.ACTIVE, {PermissionCode.DATA_PRODUCT_READ}),
]
