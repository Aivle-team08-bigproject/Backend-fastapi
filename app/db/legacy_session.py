...
connect_args = {"check_same_thread": False} if settings.requirements_database_url.startswith("sqlite") else {}
engine = create_engine(settings.requirements_database_url, connect_args=connect_args)
